...
class TrackPlotHandler:
    ...
    def __init__(self, histfilename, cuts_selection):    
        ...
        for collection in self.collections:
            ...
            if collection == 'dsa': self.h_dxy[collection]       = r.TH1F("h_dxy_{0}".format(collection),r";|d_{xy}| (cm);N events",100,0,800)
            if collection == 'dgl': self.h_dxy[collection]       = r.TH1F("h_dxy_{0}".format(collection),r";|d_{xy}| (cm);N events",100,0,100)
