...
class MuonPlotHandler:
    ...
    def __init__(self, histfilename, cuts_selection):    
        ...
        self.collections = ['dmu_dsa','dmu_dgl']
        for collection in self.collections:
            ...
            if collection == 'dmu_dsa': self.h_dxy[collection]             = r.TH1F("h_dxy_{0}".format(collection),r";|d_{xy}| (cm);N events",100,0,800)
            if collection == 'dmu_dgl': self.h_dxy[collection]             = r.TH1F("h_dxy_{0}".format(collection),r";|d_{xy}| (cm);N events",100,0,100)
